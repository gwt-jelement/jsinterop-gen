    ...
    private void createArgument(List<String> tokens, List<MethodArgument> arguments) {
        ...
        if (!tokens.isEmpty()) {
            ...
            if (type.indexOf('|') != -1) {
                ...
                arguments.add(new MethodArgument(name, parsingContetxt.getTypeFactory().getUnionType(types), false, optional, defaultValue));
            } else {
                arguments.add(new MethodArgument(name, parsingContetxt.getTypeFactory().getType(type),
